...
<html lang="pt-br">
   ...
   <body class="text-center">
      ...
      <main class="form-signin">
         <form action="efetuar-sign" method="POST">
            <h1 class="h3 mb-5 fw-normal">Criar conta</h1>
            ...
            <button class="btn w-100 btn-lg btn-success" type="submit">Inscrever-se</button>
         </form>
      </main>
